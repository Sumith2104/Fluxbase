...
export const FLUX_MODEL_REGISTRY: Record<string, FluxModelSpec> = {
  ...
  'flux-turbo': {
    ...
    maxOutputTokens: 8192,
    minTier: 'free',
    capabilities: ['text-generation', 'chat', 'tool-calling', 'json-mode', 'fast'],
  },
  'flux-vision': {
    id: 'flux-vision',
    modality: 'text',
  ...
  'flux-image-hd': {
    ...
    upstreamEndpoint: PROVIDER_ENDPOINTS.glm.images,
    label: 'Flux Image HD',
    description: 'High-definition photorealistic text-to-image synthesis powered by CogView 4',
    minTier: 'free',
  ...
  'flux-image-pro': {
    ...
    description: 'Premium creative composition with prompt adherence powered by CogView 4',
    minTier: 'free',
  ...
  'flux-image-ultra': {
    ...
    description: 'State-of-the-art photorealistic image generation powered by CogView 4',
    minTier: 'free',
