                                ...
                                <table className="w-full text-left bg-card">
                                    ...
                                    <tbody className="divide-y divide-border/60">
                                        {[
                                            ...
                                            { id: 'flux-turbo', tier: 'Hyper-Speed', speed: '300+ TPS', desc: 'Hyper-speed 300+ tokens/sec inference engine.' },
                                            { id: 'flux-max', tier: 'Flagship Vision', speed: 'Fast', desc: 'Flagship vision, multimodal reasoning, and robust coding benchmarks.' },
